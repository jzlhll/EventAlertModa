...
EA_XOPT_NEXTLINE_SHOW   = "額外行顯示(A)"
EA_XOPT_NEXTLINE_SHOW_TOAST   = "Allan add:這個buff/debuff將會在一個單獨行中顯示"
...
EA_XCMD_VER = "By \124cff00FFFFAllan@NGA紫大\124r Whitep@雷鱗 版本: ";
EA_XCMD_DEBUG = " 模式: ";
